...
# KSanchez,2020.12.07,Modified code to complete assignment 8
# ------------------------------------------------------------------------ #
...
class Product:
    ...
    changelog: (When,Who,What)
        ...
        KSanchez,2020.12.09,Modified code to complete assignment 8
    """
    ...
    def __str__(self):
        ...
        return self.__product_name + "," + str(self.product_price)
...
class FileProcessor:
    ...
    def save_data_to_file(file_name, list_of_product_objects):
        """Writes data to a file from a list of product rows
...
class IO:
    ...
    def print_menu_items():
        ...
        4) Exit program 
        """)
        print()  # Adds an extra line for looks
    ...
    def print_current_list_items(list_of_rows: list):
        """Prints the current items in the list of rows.
